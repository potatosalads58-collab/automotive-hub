      ...
      <footer className="bg-zinc-950 border-t border-zinc-800 px-6 py-14">
        ...
        <div className="grid grid-cols-3 gap-6 mb-10">
          ...
          <div>
            ...
            <a href={INSTAGRAM_URL} target="_blank" className="block text-sm text-zinc-400 hover:text-white mb-2.5 transition-colors">Instagram</a>
            <a href="#" className="block text-sm text-zinc-400 hover:text-white mb-2.5 transition-colors">TikTok</a>
            <a href={FACEBOOK_URL} target="_blank" className="block text-sm text-zinc-400 hover:text-white mb-2.5 transition-colors">Facebook</a>
          </div>
        </div>
        <div className="border-t border-zinc-800 pt-8 mb-8">
          <p className="text-xs tracking-widest text-white font-semibold mb-4">CONTACT</p>
          <div className="flex flex-col gap-2">
            <a href={`tel:${PHONE}`} className="text-sm text-zinc-400 hover:text-white transition-colors">📞 {PHONE_DISPLAY}</a>
            <a href={`mailto:${EMAIL}`} className="text-sm text-zinc-400 hover:text-white transition-colors">✉️ {EMAIL}</a>
